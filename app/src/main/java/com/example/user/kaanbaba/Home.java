...
import static com.example.user.kaanbaba.R.id.action_profil;

import static com.example.user.kaanbaba.R.id.adminpan;
import static com.example.user.kaanbaba.R.id.search_bar;
import static com.example.user.kaanbaba.R.id.visible;
...
//        searchView.setSearchableInfo(searchManager.getSearchableInfo(getComponentName()));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == adminpan) {
            if (auth.getCurrentUser().getEmail().equalsIgnoreCase("c4ltechno@gmail.com") || auth.getCurrentUser().getEmail().equalsIgnoreCase("emirtrn13@gmail.com")) {
